...
class MathsQuiz:
    def __init__(self,parent):
        ...
        self.StartButton = Button(self.QuestionsFrame, text = "Start", command = self.NextQuestion)
        ...
        self.NextButton = Button(self.QuestionsFrame, text = "Next Question", command = self.check_answer)
        self.NextButton.grid(row = 8, column = 1)
        
        self.CheckButton = Button(self.QuestionsFrame, text = "Check", command = self.check_answer)
